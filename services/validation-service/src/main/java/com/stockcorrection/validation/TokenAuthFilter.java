...
/**
 * Verifies the incoming Authorization token against auth-service on every
 * request and attaches the resulting identity as request attributes.
 * storeId/employeeId/role are never trusted from request params/body.
 */
@Component
